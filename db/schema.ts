...
// ✅ Complete ActionLogEntry — every field the agent writes must be here
export interface ActionLogEntry {
  ...
  category?: string;
  needsReply?: boolean;
  // ✅ draftReply stores the actual text (used by EmailDetail to render it)
  draftReply?: string | null;
  // ✅ draftCreated is the boolean flag (used for stats counting)
  ...
  // ✅ calendarEvents was missing — caused it to be dropped from the log
  calendarEvents?: {
    title: string;
    description: string;
    date: string;
...
// ✅ ProcessedEmail is ActionLogEntry + processedAt timestamp from the run
